#!/usr/bin/env bash
# =============================================================================
# run_graphrag_local_eval.sh
# 运行 GraphRAG Local Search × ORD-QA 评估
# Local Search = 以实体关系图为核心的精准检索，适合功能性问题
...
OUTPUT="${ROOT_DIR}/eval/results/graphrag_local_results.json"
...
echo "[步骤 2/2] 开始评估（Local Search）..."
cd "${GRAPHRAG_DIR}"

EXTRA_ARGS="--query_type local"
...
echo ""
echo "✅ GraphRAG Local 评估完成！结果: ${OUTPUT}"
